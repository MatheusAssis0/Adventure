...
namespace DialogueEditor
{
    public class ConversationManager : MonoBehaviour
    {
        ...
        //public UIConversationButton ButtonContinuePrefab;
        // Default values
        ...
        /*private UIConversationButton CreateButtonContinue()
        {
            UIConversationButton button = GameObject.Instantiate(ButtonContinuePrefab, OptionsPanel);
            m_uiOptions.Add(button);
            return button;
        }*/
